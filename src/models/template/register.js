    ...
    <![endif]-->
      ...
      <![endif]-->
        ...
        <tr>
          ...
          <tbody><tr>
            <td style="background-color:#ffffff; padding:10px 40px 50px 40px; line-height:22px; text-align:inherit;" height="100%" valign="top" bgcolor="#ffffff"><div><div style="font-family: inherit; text-align: center"><span style="font-family: Poppins">Bienvenido ${name}, a continuación podrás validar tu cuenta para que puedas ingresar a nuestra plataforma y utilizar todas sus funcionalidades.</span></div><div></div></div></td>
          </tr>
